...
const Carousel = (($) => {
  ...
  class Carousel {
    ...
    constructor(element, config) {
      ...
      this._indicatorsElement = SelectorEngine.findOne(this._element, Selector.INDICATORS)
    ...
    pause(event) {
      ...
      if (SelectorEngine.findOne(this._element, Selector.NEXT_PREV) &&
    ...
    to(index) {
      this._activeElement = SelectorEngine.findOne(this._element, Selector.ACTIVE_ITEM)
    ...
    _getItemIndex(element) {
      this._items = $.makeArray(SelectorEngine.find(element.parentNode, Selector.ITEM))
    ...
    _triggerSlideEvent(relatedTarget, eventDirectionName) {
      ...
      const fromIndex   = this._getItemIndex(SelectorEngine.findOne(this._element, Selector.ACTIVE_ITEM))
    ...
    _slide(direction, element) {
      const activeElement = SelectorEngine.findOne(this._element, Selector.ACTIVE_ITEM)
    ...
    static _dataApiClickHandler(event) {
      ...
      const config     = Util.extend(Util.extend({}, Data.getData(target, DATA_KEY)), Data.getData(this, DATA_KEY))
